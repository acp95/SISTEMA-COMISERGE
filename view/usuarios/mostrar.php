					        ...
					        <table id="myTable" cellspacing="0" width="100%">
					            <thead>
					                <tr>
					                   ...
					                   <th class="min-tablet">Privilegio</th>     
					            ...
					            <tbody>
									<?php foreach($data as $d):?>
										<tr>
											<td><span class="text-muted"><?php echo $d->id; ?></span></td>
                                                    <td><span class="text-muted"><?php echo $d->nombre; ?></span></td>
                                                    <td><span class="text-muted"><?php echo $d->usuario; ?></span></td>
                               ...
                               if($d->privilegio == '1')
                                   ...
                                   if($d->privilegio == '2')
                               echo "<span class='label label-success'>Almacenero</span>";

                            else 
                                   if($d->privilegio == '3')
                               echo "<span class='label label-danger'>Trabajador</span>";
                                   
                               ?></td>

													<td><span class="text-muted"><?php echo $d->fecha; ?></span></td>
													
													<td>
														<a href="#edit_<?php echo $d->id; ?>"title="Editar datos"  class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                                                        <a href="#pass_<?php echo $d->id; ?>"title="Password"  class="btn btn-warning btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></a>

														<a href="#delete_<?php echo $d->id; ?>"title="Eliminar datos" data-toggle="modal" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash del-btn" aria-hidden="true"></span></a>
